<?php
include("editor-profile-settings.php");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE editors SET name=?, address=?, contact_number=?, first_name=?, middle_name=?, last_name=? " . ($targetFile ? ", image_path=?" : "") . " WHERE name=?";
    ...
    if ($stmt) {
        ...
        if ($result) {
            ...
            echo '<script>window.location.href = "editor-profile-settings.php";</script>';
        } else {
