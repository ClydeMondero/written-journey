<?php
include("reviewer-profile-settings.php");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE reviewers SET name=?, address=?, contact_number=?, first_name=?, middle_name=?, last_name=? " . ($targetFile ? ", image_path=?" : "") . " WHERE name=?";
    ...
    if ($stmt) {
        ...
        if ($result) {
            ...
            echo '<script>window.location.href = "reviewer-profile-settings.php";</script>';
        } else {
