...
<body>
    <div class="sidebar">
        <div class="content">
            <a href="reviewer-profile-settings.php?newUsername=<?php echo urlencode($editorName); ?>">
                <button class="reviewers-btn">
                    <img src="<?php echo htmlspecialchars($profile_picture); ?>" alt="Profile Picture">
                    <label> <?php echo htmlspecialchars($editorName); ?> </label>
                </button>
            </a>
            <div class="btn">
                <a href="status-reviewer-articles.php"><button class="dashboard"> <span> ARTICLES </span> </button></a>
