...
if (isset($_POST['submit_review'])) {
    ...
    if (mysqli_query($conn, $updateQuery)) {
        echo "<script>alert('Review submitted successfully'); window.location.href = 'status-reviewer-articles.php';</script>";
    } else {
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="new_status" id="new_status" class="form-select">
                            <option value="Accepted by Reviewer" <?php echo $article['status'] == 'Accepted by Reviewer' ? 'selected' : ''; ?>>Accepted by Reviewer</option>
                            <option value="Rejected by Reviewer" <?php echo $article['status'] == 'Rejected by Reviewer' ? 'selected' : ''; ?>>Rejected by Reviewer</option>
                        </select>
                    </div>
                    <div class="mb-3">
