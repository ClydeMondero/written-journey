<?php
include("author-profile-settings.php");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE authors SET name=?, address=?, contact_number=?, first_name=?, middle_name=?, last_name=? " . ($targetFile ? ", image_path=?" : "") . " WHERE name=?";
    ...
    if ($stmt) {
        ...
        if ($result) {
            ...
            echo '<script>window.location.href = "author-profile-settings.php";</script>';
        } else {
